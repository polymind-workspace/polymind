...
const config: ReturnType<typeof defineConfig> = defineConfig({
  ...
  /**
   * @name devServer historyApiFallback
   * @description allow direct refresh on non-root routes during development
   */
  ...
  define: {
    ...
    'process.env.POLYMIND_NETWORK': process.env.POLYMIND_NETWORK,
    'process.env.VITE_SOLANA_CLUSTER': process.env.VITE_SOLANA_CLUSTER,
    'process.env.VITE_SOLANA_RPC': process.env.VITE_SOLANA_RPC,
    'process.env.VITE_SOLANA_WS': process.env.VITE_SOLANA_WS,
